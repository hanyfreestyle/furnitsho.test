( function ( $ ) {
        ...
        $.fn.kallesLoadQuickView = function (proid) {
           // alert(proid)
            const $btn       = $( this ),
                  $container = $( '#quick-view-tpl-'+proid ),
        ...
        $.fn.kallesLoadQuikShop = function (proid) {
            const $btn       = $( this ),
                  $container = $( '#quick-shop-tpl-'+proid ),
                  data       = $container.length ? $container.html() : null;
        ...
        body.on( 'click', '.js_add_qv , .js__qs', function ( e ) {
            ...
            setTimeout( function () {
                if ( $this.hasClass( 'js__qs' ) ) {
                    $this.kallesLoadQuikShop(proid);
                } else {
                    $this.kallesLoadQuickView(proid);
                }
            }, delay );
        } );
