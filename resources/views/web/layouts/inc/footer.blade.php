            ...
            <div class="widget widget_nav_menu">
              ...
              <div class="menu_footer widget_footer">
                <ul class="menu">
                  ...
                  <li class="menu-item"><a href="{{route('ProductsCategoriesList')}}">{{__('web/menu.mobile_t_categories')}}</a></li>
                  <li class="menu-item"><a href="{{route('page_ShopView')}}">{{__('web/menu.main_shop')}}</a></li>
