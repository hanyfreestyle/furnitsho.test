...
use App\AppCore\AdsPhoto\AdsBannerController;
...
Route::get('/ads-banner/list', [AdsBannerController::class, 'index'])->name('adsBanners.index');
Route::get('/ads-banner/add/{key}', [AdsBannerController::class,'create'])->name('adsBanners.addNew')->where('key', 'header|footer');
Route::post('/ads-banner/store/{id}', [AdsBannerController::class,'storeUpdate'])->name('adsBanners.storeUpdate');
Route::get('/ads-banner/edit/{id}', [AdsBannerController::class,'edit'])->name('adsBanners.edit');
Route::get('/ads-banner/delete/{id}', [AdsBannerController::class,'destroy'])->name('adsBanners.destroy');


//Route::get('/sortDefPhoto/ListAll', [DefPhotoController::class,'sortDefPhotoList'])->name('config.defPhoto.sortDefPhotoList');
//Route::post('/ads-banner/saveSort', [DefPhotoController::class,'sortDefPhotoSave'])->name('adsBanners.sortDefPhoto');
